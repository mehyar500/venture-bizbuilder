// functions/api/bizbuilder/_lib/ai.js
// Thin Workers AI helpers for BizBuilder. No secrets, no hardcoded keys —
// everything runs through the env.AI binding.
//
...
export const MODELS = {
  ...
  image: "@cf/black-forest-labs/flux-1-schnell", // returns {image: base64}
};
